...
- 2D-планировка: стены, окна, двери, мебель, рулетка
- 1 или 2 этажа, типы кровли и фундамента
- Помещения и площади, проверки контура
- Автоматический каркас, проекции, раскрой, смета, теплопотери
- Импорт/экспорт JSON, отмена/повтор, PDF-отчёт
