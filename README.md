...
Расчёт каркаса — инженерная модель по СП 31-105-2002 с проверкой пролётов, нагрузок и прогибов (L/360). Не замена полного расчёта конструктора по СП 20 / СП 64, но даёт рабочую проверку сечений на этапе планировки.
